...
class AddStatement extends AbstractStatement implements AddStatementInterface
{
    ...
    public function toQuery(): string
    {
        ...
        return sprintf('%sADD %sGRAPH %s TO GRAPH %s', $preQuery, $silent, $this->sourceGraph->serialize(), $this->destinationGraph->serialize());
    }
