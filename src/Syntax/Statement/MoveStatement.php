...
class MoveStatement extends AbstractStatement implements MoveStatementInterface
{
    ...
    public function toQuery(): string
    {
        ...
        return sprintf('%sMOVE %sGRAPH %s TO GRAPH %s', $preQuery, $silent, $this->sourceGraph->serialize(), $this->destinationGraph->serialize());
    }
