...
class StrAfter extends AbstractBinaryOperator implements BinaryOperatorInterface
{
    ...
    {
        return sprintf('STRAFTER(%s,%s)', $this->leftExpression->serialize(), $this->rightExpression->serialize());
    }
}
