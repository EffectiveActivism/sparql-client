...
class StrDt extends AbstractBinaryOperator implements BinaryOperatorInterface
{
    ...
    {
        return sprintf('STRDT(%s,%s)', $this->leftExpression->serialize(), $this->rightExpression->serialize());
    }
}
