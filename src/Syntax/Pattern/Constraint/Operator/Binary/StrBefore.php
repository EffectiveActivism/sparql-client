...
class StrBefore extends AbstractBinaryOperator implements BinaryOperatorInterface
{
    ...
    {
        return sprintf('STRBEFORE(%s,%s)', $this->leftExpression->serialize(), $this->rightExpression->serialize());
    }
}
