...
class StrEnds extends AbstractBinaryOperator implements BinaryOperatorInterface
{
    ...
    {
        return sprintf('STRENDS(%s,%s)', $this->leftExpression->serialize(), $this->rightExpression->serialize());
    }
}
