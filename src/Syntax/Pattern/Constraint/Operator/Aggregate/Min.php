...
class Min extends AbstractAggregateOperator implements AggregateInterface
{
    ...
    {
        if ($this->isDistinct) {
            return sprintf('MIN(DISTINCT %s)', $this->expression->serialize());
        }
        return sprintf('MIN(%s)', $this->expression->serialize());
    }
}
