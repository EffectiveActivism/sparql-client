...
class Sample extends AbstractAggregateOperator implements AggregateInterface
{
    ...
    {
        if ($this->isDistinct) {
            return sprintf('SAMPLE(DISTINCT %s)', $this->expression->serialize());
        }
        return sprintf('SAMPLE(%s)', $this->expression->serialize());
    }
}
