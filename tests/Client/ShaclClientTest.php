...
class ShaclClientTest extends KernelTestCase
{
    public function testValidation()
    {
        ...
        $insertStatement = (new InsertStatement([new Triple($subject, $predicate, $object)]))
        ...
        $deleteStatement = (new DeleteStatement([new Triple($subject, $predicate, $object)]))
            ->withNamespaces(['schema' => 'http://schema.org/'])
            ->where([
                new Triple($subject, $predicate, new Variable('object')),
            ]);
        ...
        $result = $shaclClient->validate($statement);
        $this->assertTrue($result->getStatus());
        $replaceStatement = (new ReplaceStatement([new Triple($subject, $predicate, $object)]))
            ->with([new Triple($subject, $predicate, $object)])
            ->withNamespaces(['schema' => 'http://schema.org/'])
            ->where([
                new Triple($subject, $predicate, new Variable('object')),
            ]);
        ...
        $result = $shaclClient->validate($statement);
        $this->assertTrue($result->getStatus());
        $constructStatement = (new ConstructStatement([new Triple($subject, $predicate, $object)]))
            ->withNamespaces(['schema' => 'http://schema.org/'])
            ->where([
                new Triple($subject, $predicate, new Variable('object')),
            ]);
    ...
    public function testFailedValidation()
    {
        ...
        $predicate = new PrefixedIri('schema', 'headline');
        $object = new PlainLiteral('Lorem Ipsum');
        $statement = (new InsertStatement([new Triple($subject, $predicate, $object)]))
            ->withNamespaces(['schema' => 'http://schema.org/'])
            ->where([
                new Triple($subject, $predicate, new Variable('object')),
            ]);
    ...
    public function testValidationException()
    {
        ...
        $predicate = new PrefixedIri('schema', 'headline');
        $object = new PlainLiteral('Lorem Ipsum');
        $statement = (new InsertStatement([new Triple(new Variable('unclausedSubject'), $predicate, $object)]))
            ->withNamespaces(['schema' => 'http://schema.org/'])
            ->where([
                new Triple($subject, $predicate, new Variable('object')),
            ]);
