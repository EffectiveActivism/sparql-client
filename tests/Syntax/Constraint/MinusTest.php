...
use EffectiveActivism\SparQlClient\Syntax\Constraint\Minus;
...
class MinusTest extends KernelTestCase
{
    ...
    const SERIALIZED_FILTER_NESTED = self::NAMESPACES . ' SELECT ?subject WHERE { ?subject schema:headline "lorem" . MINUS { MINUS { ?subject schema:identifier "b5e80b02-9081-11eb-af19-3b334e80a450" . } . } . }';
    ...
    public function testMinusNested()
    {
        $kernel = new TestKernel('test', true);
        $kernel->boot();
        /** @var SparQlClientInterface $sparQlClient */
